...
import io
import os
img = cv2.imread(os.path.join(os.getcwd(),r"images\PAN2.jpg"))
...
if var < 40:
    ...
    exit(1)
filename = os.path.join(os.getcwd(),r"images\PAN2.jpg")

pytesseract.tesseract_cmd = os.path.join(r"E:\Tesseract-OCR\tesseract.exe")
